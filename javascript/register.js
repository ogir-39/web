...
function checkPassword() {
    ...
    if (password != password1) {
        $(wrong).removeClass('hidden').html('Mật khẩu không trùng khớp');
        flag = false;
        $('#password').val('');
        ...
        if ($('#password1').val() == '') {
            $('#matKhau1').addClass('bienDoiChu1').on('animationend', function () {

                $('#matKhau1').removeClass('bienDoiChu1').css({
                    'font-size': '0.9rem',
                    'top': '0.5rem',
                    'left': '0.5rem'
                });
...
function desktop()
{
    $('*').off();
        ...
        $('#name').focus(function () {
            if ($('#name').val() == '') {
                $('#ho').addClass('bienDoiChu').on('animationend', function () {
            ...
            $('#name').blur(function () {
                ...
                if ($('#name').val() == '') {
                    $('#ho').addClass('bienDoiChu1').on('animationend', function () {

                        $('#ho').removeClass('bienDoiChu1').css({
                            'font-size': '0.9rem',
                            'top': '0.5rem',
                            'left': '0.5rem'
                        });
        ...
        $('#phone').focus(function () {
            if ($('#phone').val() == '') {
                $('#soDienThoai').addClass('bienDoiChu').on('animationend', function () {
                    $(this).removeClass('bienDoiChu').css({
                        'font-size': '0.7rem',
                        'top': '-16px',
                        'left': '0px'
            ...
            $('#phone').blur(function () {
                ...
                if ($('#phone').val() == '') {
                    $('#soDienThoai').addClass('bienDoiChu1').on('animationend', function () {

                        $('#soDienThoai').removeClass('bienDoiChu1').css({
                            'font-size': '0.9rem',
                            'top': '0.5rem',
                            'left': '0.5rem'
                        });
        ...
        $('#password1').focus(function () {
            if ($('#password1').val() == '') {
                $('#matKhau1').addClass('bienDoiChu').on('animationend', function () {
                    $(this).removeClass('bienDoiChu').css({
                        'font-size': '0.7rem',
                        'top': '-16px',
                        'left': '0px'
